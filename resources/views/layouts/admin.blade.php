...
<head>
  ...
  <title>@yield('title', 'Dashboard') — HarumLaundry Admin</title>
          ...
          <div class="nav-item dropdown px-3">
            <a href="#" class="nav-link d-flex lh-1 text-reset p-0 align-items-center gap-2" data-bs-toggle="dropdown">
              ...
              <div>
                ...
                <div class="mt-1 small text-white-50" style="font-size: 11px;">{{ auth()->user()->role->label ?? 'Admin' }}</div>
              </div>
            </a>
  ...
  <div class="page-wrapper">
    ...
    <footer class="footer footer-transparent d-print-none">
      <div class="container-xl text-center">
        HarumLaundry Admin &copy; {{ date('Y') }}
      </div>
    </footer>
  </div>
</div>
